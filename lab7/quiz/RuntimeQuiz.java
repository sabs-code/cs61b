...
public class RuntimeQuiz {
    ...
    public static Runtime f1_o_runtime = Runtime.QUADRATIC;
    public static Runtime f1_theta_runtime = Runtime.QUADRATIC;
    ...
    public static Runtime f2_omega_runtime = Runtime.LINEAR;
    public static Runtime f2_o_runtime = Runtime.CUBIC;
    ...
    public static Runtime f3_omega_runtime = Runtime.CONSTANT;
    ...
    public static Runtime f4_omega_runtime = Runtime.CONSTANT;
    ...
    public static Runtime f5_o_runtime = Runtime.LINEARITHMIC;
    public static Runtime f5_theta_runtime = Runtime.LINEARITHMIC;
    ...
    public static Runtime f7_theta_runtime = Runtime.EXPONENTIAL;
