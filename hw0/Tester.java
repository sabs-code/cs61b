...
public class Tester {
    ...
    public void maxTest() {
        ...
        assertEquals(14, max.maxfunc(new int[] { 0, -5, 2, 14, 10 }));
    ...
    public void threeSumTest() {
        ...
        assertTrue(threesum.checksum(new int[] { -6, 3, 10, 200 }));
        // REPLACE THIS WITH MORE TESTS.
    }
    ...
    public void threeSumDistinctTest() {
        ...
        assertFalse(threeSumDistinct.checksum(new int[] { -6, 3, 10, 200 }));
        // REPLACE THIS WITH MORE TESTS.
    }
